...
\begin{minipage}{\linewidth}
  ...
  \end{center}
  \caption{Distribution of start kmers to address space (Short data set)} \label{fig:smer_dist_small}
\end{minipage}
